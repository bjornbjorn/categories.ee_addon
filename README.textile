...
* only_count_status _(optional)_ used in conjunction with fetch_entry_counts if you only want to coint entries with a certain status (e.g. open, closed, featured, etc.) You can use the | separator here (e.g. only_fetch_counts='open|featured')
